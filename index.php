...
wx.config({
  ...
  appId: 'wx0dbfa01c4910c0da', // 必填，公众号的唯一标识
  timestamp: 20150306, // 必填，生成签名的时间戳
  nonceStr: '', // 必填，生成签名的随机串
  signature: '',// 必填，签名，见附录1
  jsApiList: [] // 必填，需要使用的JS接口列表，所有JS接口列表见附录2
});
var dataForWeixin = {
  MsgImg: "finder",//图片地址，以 http:// 开头，分享给朋友/朋友圈图片
  url: "http://www.liubeismx.cn/favicon.ico", //分享出去的链接地址，以 http:// 开头
  title: "finder", //分享标题
  desc: "关于技术，关于互联网，关于自己", //分享详细说明
  callback: function(){} //分享回调函数
};
//  分享到朋友圈
